...
The representation I am using for the project will be strings and sequences. I am using strings
to represent all the names of outfits that can be used ex: yellow t shirt, red shoes,
etc. I also chose a sequence so I could modify the data easily, or how I saw best fitting
for an outfit maker component.
...
For my component I will be using sequences and strings to
